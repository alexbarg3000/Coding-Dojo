...
<div id="container">
    <div id="header">
        <h2 id="counter">Your Gold: <c:out value="${gold}"/> <br> <a class="btn btn-primary button-margin"
                                                                   href="/reset">Reset!</a></h2>
    ...
    <div id="forms">
        ...
        <form class="form" action="/process" method="post">
            ...
            <img src="/images/spa.jpg" alt="Picture of a spa">
            <h3 id="desc">(takes 5-20 golds)</h3>
            <input type="hidden" name="building" value="spa">
            <a href='/process_money'><button type="submit" class="btn btn-warning">Relax!</button></a>
        </form>
    </div>
    <div id="output">
        <ul>
