package com.codingdojo.java.spring.taskmanager.controllers;
...
import com.codingdojo.java.spring.taskmanager.services.TaskService;
import com.codingdojo.java.spring.taskmanager.services.UserService;
import com.codingdojo.java.spring.taskmanager.validator.UserValidator;
...
//			model.addAttribute("user", new User());
    ...
    public String deleteTask(@PathVariable("id") Long myId, HttpSession session) {
        if (session.getAttribute("userId") == null) {
            return "redirect:/";
        }
