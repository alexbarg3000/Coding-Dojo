package com.codingdojo.java.spring.group_project.config;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.
                authorizeRequests()
                .antMatchers("/").permitAll()//notesssss
                .antMatchers("/css/", "/js/", "/registration","/home","/adding","/createCategory","/createSubCategory").permitAll()//edited
